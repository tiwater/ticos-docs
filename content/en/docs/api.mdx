---
title: "API Reference"
description: "Comprehensive API documentation for Ticos Platform"
---

# API Reference

Ticos Platform provides a comprehensive set of APIs for managing embodied AI terminals, handling face recognition, and integrating with LLM capabilities. This documentation covers all available API endpoints and their usage.
