...
- **Response Format**: You can specify the format of the model output, such as forcing it to return JSON objects, to ensure downstream applications can stably process the model output.
