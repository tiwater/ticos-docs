...
Its primary purpose is to "View your API usage metrics."
...
3.  Within the account settings, navigate to the "Usage" section.
...
-   **Date Range Selection**: A date picker allows you to select a specific period for which to view usage data. This is crucial for analyzing trends or checking consumption for a particular billing cycle.
